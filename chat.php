...
<head>
    ...
    <title>Chat - Support Teens</title>
    <link rel="stylesheet" type="stylesheet" href="chat.css">
                    ...
                    <div class="col-12 col-lg-5 col-xl-3 border-right">
                        ...
                        <a href="#" class="list-group-item list-group-item-action border-0">
                            ...
                            <div class="d-flex align-items-start">
                                <img src="/public/user.png" class="rounded-circle mr-1" alt="Vanessa Tucker" width="40"
                                    height="40">
                        ...
                        <a href="#" class="list-group-item list-group-item-action border-0">
                            <div class="d-flex align-items-start">
                                <img src="/public/user.png" class="rounded-circle mr-1" alt="Jennifer Chang" width="40"
                                    height="40">
                                <div class="flex-grow-1 ml-3">
                                    User
                        ...
                        <div class="py-2 px-4 border-bottom d-none d-lg-block">
                            <div class="d-flex align-items-center py-1">
                                <div class="position-relative">
                                    <img src="/public/user.png" class="rounded-circle mr-1" alt="Sharon Lessman"
                                        width="40" height="40">
                                </div>
                                <div class="flex-grow-1 pl-3">
                                    <strong>User</strong>
                                    <div class="text-muted small"><em>Escrevendo</em></div>
                                </div>
                                <div>
                        ...
                        <div class="position-relative">
                            <div class="chat-messages p-4">
                                <div class="chat-message-right pb-4">
                                    <div>
                                        <img src="/public/user.png" class="rounded-circle mr-1" alt="Chris Wood"
                                            width="40" height="40">
                                ...
                                <div class="chat-message-left pb-4">
                                    <div>
                                        <img src="/public/user.png" class="rounded-circle mr-1" width="40" height="40">
